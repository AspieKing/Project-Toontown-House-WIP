...
class OTPBase(ShowBase):
    ...
    def __init__(self, windowType = None):
        ...
        if not self.idTags:
            del self.idTags
        self.wantNametags = ('want-nametags', 1)
        self.slowCloseShard = ('slow-close-shard', 0)
        self.slowCloseShardDelay = ('slow-close-shard-delay', 10.0)
        self.fillShardsToIdealPop = ('fill-shards-to-ideal-pop', 1)
        self.logPrivateInfo = ('log-private-info', __dev__)
